...
if ( isset($_POST["detail-keluhan"])) {
    ...
    header("Location:admin-detail-keluhan.php");
    exit;
}

$result_proses = mysqli_query($conn, "SELECT * FROM tiketkeluhan WHERE status_ID != 5 ORDER BY ID DESC");
$result_selesai = mysqli_query($conn, "SELECT * FROM tiketkeluhan WHERE status_ID == 5 ORDER BY ID DESC");
?>
...
<head>
    ...
    <link rel="stylesheet" href="/styles/admin-keluhan-styles.css">
...
<body>
    ...
    <div class="content">
        ...
        <!--div class="kotak-keluhan">
            ...
            <a class="tombol-detail-keluhan tombol-keluhan-hover" href="admin-detail-keluhan.php">Detail Keluhan</a>
        </div-->

        <h2>Keluhan Selesai</h2>
